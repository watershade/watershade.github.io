...
![power switch schmatic](/assets/images/power_switch.png)
...
![nice board](/assets/images/A1.jpg)
...
![短路测试硬件](/assets/images/短路测试硬件.jpg)
<p style="text-align:center; color:orange">图3：短路测试接线图 </p>

然后用逻辑分析仪获得的波形如下：
![逻辑分析仪测试波形](/assets/images/逻辑分析仪测试.png)
