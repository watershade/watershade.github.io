...
category: CAN FD
date: '2024-01-10'
description: STM32 CAN FD 位定时配置与思考
tags:
- CAN FD
- 位定时
- STM32
...
![image.png](/assets/images/CAN_FD_Config.png)
...
![CAN FD传输阶段](/assets/images/CAN_FD传输阶段.png)
...
![Norminal Bit time](/assets/images/位定时0.png)
<p style="text-align:center; color:orange">图3：标称位定时 </p>

![Data Bit time](/assets/images/位定时1.png)
...
![各时段要求表格](/assets/images/位定时各时段要求.png)
...
![传播延迟](/assets/images/CAN传播延迟.png)
...
### 2.5.1 理想采样点
![分析情况图1](/assets/images/分析情况1.png)
...
![采样点示例2-1](/assets/images/采样点示例2-1.png)
<p style="text-align:center; color:orange">图10：采样点示例2-1 </p>

我们该不该将采样点放在上图的位置呐？

![采样点示例2-2](/assets/images/采样点示例2-2.png)
...
![采样点示例3](/assets/images/采样点示例3.png)
...
![通讯距离和速率](/assets/images/CAN线长和速率.png)
...
![采样点示例4](/assets/images/采样点示例4.png)
