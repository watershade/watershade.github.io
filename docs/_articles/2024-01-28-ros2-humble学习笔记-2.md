...
中间还可能有一些警告，比如下图：
![colcon test demo](/assets/images/colcon_test_result_demo1.png)
...
![rclcpp minimal demo](/assets/images/examples_rclcpp_minimal.gif)
...
![package_xml_parse](/assets/images/package_xml_parse.png)
...
![第一次代码修改](/assets/images/ros_turtuals_change_1.png)
...
![两个不同的turtlesim](/assets/images/two_diff_turtlesim.gif)
...
![cpp_pubsub测试图](/assets/images//simple_cpp_pubsub_test.gif)
...
```
测试效果如下：
![py_pubsub_test](/assets/images/py_pubsub_test.gif)
...
```
结果如下图8所示。
![cpp_srvcli测试图](/assets/images/cpp_srvcli_test.gif)
...
![rosidl动态消息类型](/assets/images/ros_idl_api_stack_dynamic.png)
...
![rosidl动态消息类型](/assets/images/diff_publisher_member_function.png)
...
![rosidl动态消息类型](/assets/images/diff_subscriber_member_function.png)
...
```
结果如下：
![cpp_pubsub使用Num传递消息测试](/assets/images/cpp_pubsub_num_msg_test.gif)
...
测试结果如下：
![AddThreeInts传递服务消息测试](/assets/images/cpp_srvcli_add_three_ints_test.gif)
...
结果如下：
![AddressBook消息接口测试](/assets/images/address_book_test.gif)
...
```
测试如下：
![外部设置参数测试](/assets/images/set_param_from_external.gif)
...
```
测试结果如下：
![通过launch设置参数实验](/assets/images/launch_set_param.gif)
...
![ROS2](/assets/images/ros_client_library_api_stack.png)
